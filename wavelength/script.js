...
function start() {
    ...
    nextButton.onclick = () => {
        ...
        p1Button.onclick = () => {
            ...
            nextButton.onclick = () => {
                body.removeChild(nextButton);
                const tellP2 = document.createElement("p");
                tellP2.innerHTML = `Now tell P2 a word that fits your catagory of "${catagory.name}".<br>They have to guess a number between 1-20 with 1 being <b>"${subCatagory.min}"</b> and 20 being <b>"${subCatagory.max}"</b>.<br>You want to try to get them to guess the same number as the one given to you.`;
                ...
                toldButton.onclick = () => {
                    ...
                    submit.onclick = () => {
                        ...
                        comment.innerHTML = difference > 3 ? `You were ${difference} away...` : difference == 0 ? "You got the number exactly right! 0 away!" : `You were only ${difference} away! So close!`;
                        const replay = document.createElement("button");
                        replay.innerHTML = "Play Again";
                        replay.onclick = () => {
                            body.removeChild(guessH2);
                            body.removeChild(numberH2);
                        ...
                        setTimeout(() => body.appendChild(comment), 3000);
