export const themes = [
    ...
    {id: 7, name: "Blue", bg: "rgb(30, 30, 174)", text: "white", accent: "gray"},
    {id: 5, name: "Rainbow", bg: "linear-gradient(to right, red, orange, yellow, green, blue, purple)", text: "black", accent: "white"},
]